...
values."
  (setq-default
   ...
   '(
     ...
     git
     markdown
     (org :variables org-enable-reveal-js-support t org-reveal-location "/home/peter/repo/reveal.js/js/reveal.js")
     semantic
...
values."
  ...
  (setq-default
   ...
   ;; by your Emacs build.
   ;; If the value is nil then no banner is displayed. (efault 'official)
...
you should place your code here."
  ...
  (spacemacs|define-transient-state dumb-jump
    :title "Dumb Jump"
    :doc
    "\n[_g_/_o_/_e_/_x_] go/other/external\n[_i_] quicklook\n[_b_] back\n[_q_] exit"
    :bindings
    ("g" dumb-jump-go :exit t)
    ("o" dumb-jump-go-other-window :exit t)
    ("e" dumb-jump-go-prefer-external :exit t)
    ("x" dumb-jump-go-prefer-external-other-window :exit t)
    ("i" dumb-jump-quick-look :exit t)
    ("b" dumb-jump-back :exit t)
    ("q" nil :exit t)
    )
  (spacemacs/set-leader-keys "jx" 'spacemacs/dumb-jump-transient-state/body)

  (defun xah-cut-line-or-region ()
    "Cut current line, or text selection. When `universal-argument' is called first, cut whole buffer (respects `narrow-to-region')."
  ...
  (defun xah-copy-line-or-region ()
    "Copy current line, or text selection. When called repeatedly, append copy subsequent lines. When `universal-argument' is called first, copy whole buffer (respects `narrow-to-region')."
